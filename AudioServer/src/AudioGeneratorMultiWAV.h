...
#ifndef _AUDIOGENERATORMULTIWAV_H
#define _AUDIOGENERATORMULTIWAV_H

#include "AudioGenerator.h"

class AudioGeneratorMultiWAV : public AudioGenerator
{
  public:
    class FileHandle {
      friend class AudioGeneratorMultiWAV;
    private:
      AudioFileSource* src;
      uint32_t dataStart;
      uint32_t dataLength;
    ...
    virtual ~AudioGeneratorMultiWAV() override;
